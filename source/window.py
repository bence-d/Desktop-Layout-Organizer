...
class CreatePresetDialog():
    ...
    def __init__(self):
        ...
        # Window Window Elements
        self.label = tk.Label(self.window, text="Description:")
        self.label.grid(column=0, row=2, pady=10)

        self.input_desc = tk.Entry(self.window)
        self.input_desc.grid(column=0, row=3, pady=10, ipadx=20, ipady=40)

        button = tk.Button(self.window, text="Create", command=self.createPreset)
